...
const webappSrcFolder = `${__dirname}/..`;
...
function generateDataJsContent(dataFolder) {
    const nowAsUtc = new Date().toUTCString();
    let dataJsLines = [];
    dataJsLines.push(`// provided.js - generated by dashgen-cli, at ${nowAsUtc}.`);
    dataJsLines.push(`const reportsCreatedAt = new Date("${nowAsUtc}");`);
    dataJsLines.push('const reports = {');
